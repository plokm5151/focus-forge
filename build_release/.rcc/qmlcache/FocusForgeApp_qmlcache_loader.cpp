...
namespace _qt_qml_FocusForgeApp_qml_Main_qml { 
...
namespace _qt_qml_FocusForgeApp_qml_components_BreathingOrb_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _qt_qml_FocusForgeApp_qml_components_QuickCapturePopup_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_FocusForgeApp)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_FocusForgeApp))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_FocusForgeApp)() {
    return 1;
}
